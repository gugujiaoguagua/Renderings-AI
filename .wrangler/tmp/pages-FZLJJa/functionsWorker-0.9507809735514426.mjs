...
// ../.wrangler/tmp/bundle-kuvrsp/strip-cf-connecting-ip-header.js
...
__name(pickEnvValue2, "pickEnvValue");
...
__name(pickEnvValue3, "pickEnvValue");
function normalizeWorkflowType2(value) {
  const raw = typeof value === "string" ? value : "";
  const normalized = raw.trim().toUpperCase().replace(/[^A-Z0-9_]/g, "_");
  return normalized.length > 0 ? normalized : null;
}
__name(normalizeWorkflowType2, "normalizeWorkflowType");
var onRequestPost3 = /* @__PURE__ */ __name(async ({ request, env }) => {
  ...
  return json3({ ...data, taskId: data?.taskId, status: data?.status });
}, "onRequestPost");
...
// ../.wrangler/tmp/pages-FZLJJa/functionsRoutes-0.3074659043563438.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-kuvrsp/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-kuvrsp/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9507809735514426.mjs.map
